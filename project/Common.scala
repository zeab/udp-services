...
object Common {
  ...
  val useHomepage: String = "http://github.com/myproject"
  val useGitHomepage:String = "http://github.com/myproject.git"
  val useDevName: String = "YourName"
  val useDevEmail: String = "YourEmail"
  val useDevGithub: String = "http://github.com/yourmaingitname"
